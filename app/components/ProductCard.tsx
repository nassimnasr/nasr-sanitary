    ...
    <article className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition hover:-translate-y-1 hover:shadow-lg">
      ...
      <div className="p-5">
        ...
        <button
          ...
          className="mt-4 w-full rounded-lg bg-[#2F3E4D] px-4 py-2 text-sm font-semibold text-white transition hover:bg-[#2F3E4D]/90 disabled:cursor-not-allowed disabled:bg-slate-300"
        >
