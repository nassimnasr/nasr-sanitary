      ...
      <div className="grid gap-8 rounded-2xl border border-slate-200 bg-white p-6 md:grid-cols-2 md:p-8">
        ...
        <div>
          ...
          <button
            ...
            disabled={!inStock}
            className="mt-8 w-full rounded-xl bg-[#2F3E4D] px-6 py-3 text-sm font-semibold text-white transition hover:bg-[#2F3E4D]/90 disabled:cursor-not-allowed disabled:bg-slate-300"
          >
