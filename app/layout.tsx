          ...
          <LanguageProvider>
            <div className="flex min-h-screen flex-col">
              ...
              <a
                ...
                className="fixed bottom-6 right-6 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg transition hover:scale-110 hover:shadow-xl"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="fixed bottom-6 right-24 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#E4405F] shadow-lg transition hover:scale-110 hover:shadow-xl"
